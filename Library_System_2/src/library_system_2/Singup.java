...
public class Singup extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String sql ="INSERT INTO Account(username, name, password, answer) value ( ?, ?, ?, ?)";
            pst = conn.prepareStatement(sql);
            pst.setString(1, jTextField_name.getText());
            pst.setString(2, jTextField_username.getText());
            pst.setString(3, jTextField_Password.getText());          
            pst.setString(5, jTextField_Answer.getText());
            //pst.setString(4, (String) jComboBox_Question.getSelectedItem());
            pst.execute();
